    ...
    return html`
      <div class="menu">
        ...
        <nav role="navigation" aria-labelledby="menu-title">
          ...
          <div
            class="menu__underlay"
            onclick="${e => this.handleUnderlayClick()}"
          ></div>
...
class tjbMenuItemSub extends WebComponent() {
  ...
  HTML() {
    ...
    this.selectorNode = html`
      <slot name="menu-item" class="menu__sub-li"></slot>
    `;
  ...
  handleChange() {
    if (this.checkboxNode.checked) this.handleCheck();else this.handleUnCheck();
  }
