import WebComponent from"https://tjb-webcomponents.github.io/tjb-webcomponent/tjb-wc.min.js";import html from"https://tjb-webcomponents.github.io/html-template-string/html.min.js";class tjbMenu extends WebComponent(){CSS(){return html`
      <style>
        :host {
    ...
    `}handleUnderlayClick(){this.checkboxNode.checked=false}}class tjbMenuItemSub extends WebComponent(){CSS(){return html`
      <style>
        .visuallyhidden {
          border: 0;
          clip: rect(0, 0, 0, 0);
    ...
    `}handleCheck(){this.checkboxNode.classList.add("checked");setTimeout(()=>this.selectorNode.focus());document.addEventListener("click",this.handleUnCheck)}handleUnCheck(){this.checkboxNode.classList.remove("checked");setTimeout(()=>this.checkboxNode.checked=false);document.removeEventListener("click",this.handleUnCheck)}handleChange(){if(this.checkboxNode.checked)this.handleCheck();else this.handleUnCheck()}connectedCallback(){super.connectedCallback();this.handleUnCheck=this.handleUnCheck.bind(this)}}class tjbMenuItem extends WebComponent(){CSS(){return html`
      <style>
        @media screen and (min-width: 600px) {
          .menu__li {
            display: inline-block;
    ...
    `}}customElements.define("tjb-menu-item",tjbMenuItem);customElements.define("tjb-menu-item-sub",tjbMenuItemSub);customElements.define("tjb-menu",tjbMenu);
